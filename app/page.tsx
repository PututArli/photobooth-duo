      ...
      <div style={{ position: 'absolute', top: 16, right: 16, zIndex: 50, display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        >
          <div className="guide-extra">
            ...
            <div className="guide-subsection" style={{ marginTop: 32, padding: 16, background: 'rgba(255,126,95,0.1)', borderRadius: 12, border: '1px solid rgba(255,126,95,0.3)', textAlign: 'center' }}>
              <p style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 12 }}>{t('tutor.help')}</p>
              <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
                <a href="mailto:rafaelpututarli@gmail.com" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#ff7e5f', textDecoration: 'none', fontWeight: 600, fontSize: 13 }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                  Email
                </a>
                <a href="https://instagram.com/rafaelpututarli" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, color: '#ff7e5f', textDecoration: 'none', fontWeight: 600, fontSize: 13 }}>
